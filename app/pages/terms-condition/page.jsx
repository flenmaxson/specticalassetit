    ...
    <MainLayout>
      ...
      <main className="pt-28 pb-16 px-4">
        <div className="md:w-[90%] mx-auto">
          ...
          <p className="text-gray-600 mb-12">Last updated November 21, 2023</p>

          <div className="space-y-8">
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">AGREEMENT TO TERMS</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                This legally binding agreement governs your access to and use of the https://nhitservices.net website as well as any other media form, media channel, mobile website, or mobile application related, linked, or otherwise connected thereto (collectively, the "Site"). This agreement is made between you, either personally or on behalf of an entity ("you") and Spectical Asset IT ("Company", "we", "us", or "our"). The website offers the following commodities, items, and/or services as part of its online marketplace: Computer assistance (the "Marketplace Offerings"). All users must accept and abide by these Terms of Use, which include the User Agreement posted on the Site and are incorporated into these Terms of Use, in order to help make the Site a secure environment for the purchase and selling of Marketplace Offerings. You acknowledge that you have read, comprehended, and agree to be bound by all of these Terms of Use by using the Site and/or the Marketplace Offerings. You are expressly prohibited from using the website and/or marketplace offerings if you do not agree to all of these terms of use. You must stop using the website right away.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4">
Any other terms and conditions or documents that may occasionally be posted on the Site are now specifically referenced and incorporated herein. We retain the right, at any time and for any reason, to alter or amend these Terms of Use in our sole discretion. You agree to waive your right to receive specific notice of each change by agreeing that we will notify you of such updates by changing the "Last updated" date of these Terms of Use. You agree to check these Terms of Use from time to time to be aware of any revisions. Your continued use of the Site after the date on which any amended Terms of Use are posted will subject you to the changes in such revised Terms of Use and will be considered as your acceptance of such changes.

              </p>
              <p className="text-gray-700 leading-relaxed">
The information on the site is not meant to be distributed to or used by any person or organisation in any jurisdiction or nation where doing so would be illegal, subject to registration requirements in that jurisdiction or nation, or both. Therefore, if and to the extent that local laws are applicable, those who choose to visit the Site from other locations do so of their own free will and are solely responsible for abiding by local laws.

              </p>
              <p className="text-gray-700 leading-relaxed">
You may not use this Site if your interactions would be subject to laws pertaining to industry-specific regulations, such as the Federal Information Security Management Act (FISMA), the Health Insurance Portability and Accountability Act (HIPAA), etc. Use of the Site in a manner that would contravene the Gramm-Leach-Bliley Act (GLBA) is prohibited.


              </p>
              <p className="text-gray-700 leading-relaxed">
Users of the Site must be at least eighteen years old. It is prohibited for anyone under the age of 18 to use the Site, register for an account, or access the Marketplace Offerings.
...
You may be required to register with the Site in order to access the Marketplace Offerings. You agree to keep your password confidential and will be responsible for all use of your account and password. We reserve the right to remove, reclaim, or change a username you select if we determine, in our sole discretion, that such username is inappropriate, obscene, or otherwise objectionable.
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">MARKETPLACE OFFERINGS</h2>
              <p className="text-gray-700 leading-relaxed">
We reserve the right to limit the quantities of the Marketplace Offerings offered or available on the Site. All descriptions or pricing of the Marketplace Offerings are subject to change at any time without notice, at our sole discretion. We reserve the right to discontinue any Marketplace Offerings at any time for any reason. We do not warrant that the quality of any of the Marketplace Offerings purchased by you will meet your expectations or that any errors in the Site will be corrected.
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">PURCHASES AND PAYMENT</h2>
              <h4 className=" leading-relaxed mb-4 font-semibold text-lg">
...
You agree to pay all charges at the prices then in effect for your purchases and any applicable shipping fees, and you authorize us to charge your chosen payment provider for any such amounts upon placing your order. If your order is subject to recurring charges, then you consent to our charging your payment method on a recurring basis without requiring your prior approval for each recurring charge, until such time as you cancel the applicable order. We reserve the right to correct any errors or mistakes in pricing, even if we have already requested or received payment.
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">REFUNDS POLICY</h2>
              <div className="">
                <p className="text-gray-700 leading-relaxed mb-4">
Scope: This Refund Policy applies to all software products sold by Spectical Asset IT ("Company") through its official channels, including but not limited to online platforms, retail stores, and authorized distributors. Refund Period: Customers are eligible for a refund within 15 days from the date of purchase ("Refund Period"). After the Refund Period has expired, refunds will not be granted except as required by applicable law or as stated in any applicable product warranty. Eligibility Criteria: To be eligible for a refund, customers must meet the following criteria: a. The software product must have been purchased directly from the Company or an authorized distributor. b. Proof of purchase, such as a valid receipt or order confirmation, must be provided. c. The customer must request the refund within the Refund Period. d. The software product must not have been used beyond reasonable evaluation. Usage beyond reasonable evaluation may include but is not limited to activation, installation, or registration of the product. Exclusions: The following situations are not eligible for a refund: a. Products purchased from unauthorized resellers or third-party sellers. b. Products that have been tampered with, modified, or altered in any way. c. Products that have been used in violation of the terms of the End User License Agreement (EULA) or any other applicable terms and conditions. Refund Process: Customers seeking a refund must follow these steps: a. Contact Customer Support: Customers should contact our customer support team via support@nhitservices.net to initiate the refund process. The request must include the order number, product details, and reason for the refund. b. Evaluation: Upon receiving the refund request, the Company will evaluate the eligibility based on the criteria outlined in this policy. c. Refund Approval: If the refund request meets all eligibility criteria, the Company will approve the refund and provide instructions for returning the product. d. Refund Issuance: Once the returned product is received and verified, the refund will be processed using the original payment method, unless otherwise agreed upon by the customer and the Company. Exceptions: In exceptional cases where the product is defective or does not perform as advertised, the Company may offer alternatives to a refund, such as a replacement product or a credit towards future purchases. Policy Updates: The Company reserves the right to modify or update this Refund Policy at any time without prior notice. Any changes will be effective immediately upon posting on the Company's website or other official channels. Contact Information: For inquiries or assistance regarding this Refund Policy, customers can contact our customer support team at support@nhitservices.net. This Refund Policy is designed to ensure fairness and transparency in our dealings with customers regarding software sales. We appreciate your understanding and cooperation.
                </p>
...
You may not access or use the Site for any purpose other than that for which we make the Site available. The Site may not be used in connection with any commercial endeavors except those that are specifically endorsed or approved by us.
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4 flex gap-2 flex-col">
                <li>
...
Copy or adapt the Site’s software, including but not limited to Flash, PHP, HTML, JavaScript, or other code.
                ...
                <li>
                    IT Specialists can’t work for or contact Spectical Asset IT customers off the platform.

                </li>
                <li>
                    Spectical Asset IT customers can’t contact IT Specialists off the platform for private jobs.
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">USER GENERATED CONTRIBUTIONS</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
...
The creation, distribution, transmission, public display, or performance, and the accessing, downloading, or copying of your Contributions do not and will not infringe the proprietary rights, including but not limited to the copyright, patent, trademark, trade secret, or moral rights of any third party.
                ...
                <li>
                    You have the written consent, release, and/or permission of each identifiable individual person in your Contributions to use the name or likeness of each such identifiable individual person to enable inclusion and use of your Contributions in any manner contemplated by the Site and these Terms of Use.
...
GUIDELINES FOR REVIEWS
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">MOBILE APPLICATION LICENSE</h2>
              <h4 className=' leading-relaxed mb-4 font-semibold text-lg'>
                Use License
              </h4>
              <p className="text-gray-700 leading-relaxed mb-4">
